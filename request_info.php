...
if (isset($_GET['delete'])) {
  ...
  if ($con->query($sql) == true) {
    ...
    redirect('request_info.php', 'Successfullay Deleted.');
  } else {
  ...
  <div class="container-fluid">
    ...
    <main>
      <section id="main-container-fluid">
        ...
        $sql = "SELECT * FROM request_blood ORDER BY id DESC LIMIT 20";
        $results = $con->query($sql);
        // var_dump($results);
        ?>
        <div class="dashboard mt-3">
          <table class="table table-striped table-dark pt-4" id="myTable">
            <h3 class="py-3">Blood Request Info:</h3>
            <thead>
              <tr>
                <th scope="col">ID</th>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <th scope="row"><?php echo $row['required_unit'] ?></th>
                  <th scope="row"><?php echo $row['contact_person'] ?></th>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `request_info.php?delete=${delId}`;
