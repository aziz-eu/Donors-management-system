      ...
      <section id="connect ">
        <div class="container-lg">
          ...
          <div class="text-center pt-5">
            <h2 class="text-white font-weight-bolder">Can I donate if I have high blood pressure?</h2>
          </div>
          <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-10 mt-4 answer">
              <p class="px-2">Acceptable as long as your blood pressure is below 180 systolic (first number) and below 100 diastolic (second number) at the time of donation. Medications for high blood pressure do not disqualify you from donating. Source: <cite><a href="https://www.redcrossblood.org/donate-blood/how-to-donate/eligibility-requirements/eligibility-criteria-alphabetical.html">Red Cross Blood</a></cite></p>
            </div>
          </div>
        </div>
      </section>>
