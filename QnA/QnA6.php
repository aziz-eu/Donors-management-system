      ...
      <section id="connect ">
        <div class="container-lg">
          ...
          <div class="text-center pt-5">
            <h2 class="text-white font-weight-bolder">Is giving blood safe?</h2>
          </div>
          <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-10 mt-4 answer">
              <p class="px-2">Yes, donating blood is safe. You can’t get AIDS or any other infectious disease from giving blood because hospital/clinic always use new, sterile needles that are discarded after one use. Source: <cite><a href="https://www.redcrossblood.org/donate-blood/how-to-donate/common-concerns.html">Red Cross Blood</a></cite></p>
            </div>
          </div>
        </div>
      </section>>
