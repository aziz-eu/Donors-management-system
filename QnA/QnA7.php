...
<body>
  <div class="container-fluid">
    ...
    <main class="non-root QnA">
      <section id="connect ">
        <div class="container-lg">

          <div class="text-center pt-5">
            <h2 class="text-white font-weight-bolder">How will I feel after giving blood?</h2>
          </div>
          <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-10 mt-4 answer">
              <p class="px-2">People may feel fatigued or experience some dizziness, lightheadedness, or nausea after donating blood. This is because of the temporary lowering of blood pressure. If a person feels faint, they can sit down and put their head between the knees so that it is lower than the heart. Lying down with the legs elevated can also help to prevent falling. If symptoms do not improve, people can contact their doctor. Source: <cite><a href="https://www.medicalnewstoday.com/articles/blood-donation-side-effects">Medical News Today</a></cite></p>
            </div>
          </div>
        </div>
      </section>>
