      ...
      <section id="connect ">
        <div class="container-lg">
          ...
          <div class="text-center pt-5">
            <h2 class="text-white font-weight-bolder">What age do I need to be to donate? </h2>
          </div>
          <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-10 mt-4 answer">
              <p class="px-2">You are aged between 18 and 65. In some countries national legislation permits 16–17 year-olds to donate provided that they fulfil the physical and hematological criteria required and that appropriate consent is obtained. Source: <cite><a href="https://www.who.int/campaigns/world-blood-donor-day/2018/who-can-give-blood">WHO</a></cite></p>
            </div>
          </div>
        </div>
      </section>>
