      ...
      <section id="connect ">
        <div class="container-lg">
          ...
          <div class="text-center pt-5">
            <h2 class="text-white font-weight-bolder">What weight do I need to be to donate?</h2>
          </div>
          <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-10 mt-4 answer">
              <p class="px-2">You weigh at least 50 kg. In some countries, donors of whole blood donations should weigh at least 45 kg to donate 350 ml ± 10% .  Source: <cite><a href="https://www.who.int/campaigns/world-blood-donor-day/2018/who-can-give-blood">WHO</a></cite></p>
            </div>
          </div>
        </div>
      </section>>
